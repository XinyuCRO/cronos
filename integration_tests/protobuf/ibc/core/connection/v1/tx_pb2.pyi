...
class MsgConnectionOpenTry(_message.Message):
    ...
    SIGNER_FIELD_NUMBER: _ClassVar[int]
    HOST_CONSENSUS_STATE_PROOF_FIELD_NUMBER: _ClassVar[int]
    client_id: str
...
class MsgConnectionOpenAck(_message.Message):
    ...
    signer: str
    host_consensus_state_proof: bytes
    def __init__(self, connection_id: _Optional[str] = ..., counterparty_connection_id: _Optional[str] = ..., version: _Optional[_Union[_connection_pb2.Version, _Mapping]] = ..., client_state: _Optional[_Union[_any_pb2.Any, _Mapping]] = ..., proof_height: _Optional[_Union[_client_pb2.Height, _Mapping]] = ..., proof_try: _Optional[bytes] = ..., proof_client: _Optional[bytes] = ..., proof_consensus: _Optional[bytes] = ..., consensus_height: _Optional[_Union[_client_pb2.Height, _Mapping]] = ..., signer: _Optional[str] = ..., host_consensus_state_proof: _Optional[bytes] = ...) -> None: ...
...
class MsgUpdateParams(_message.Message):
    ...
    def __init__(self, signer: _Optional[str] = ..., params: _Optional[_Union[_connection_pb2.Params, _Mapping]] = ...) -> None: ...
