...
from ibc.core.commitment.v2 import commitment_pb2 as _commitment_pb2
...
class QueryConsensusStateRequest(_message.Message):
    ...
    revision_height: int
    latest_height: bool
    def __init__(self, client_id: _Optional[str] = ..., revision_number: _Optional[int] = ..., revision_height: _Optional[int] = ..., latest_height: _Optional[bool] = ...) -> None: ...
...
class QueryVerifyMembershipRequest(_message.Message):
    ...
    def __init__(self, client_id: _Optional[str] = ..., proof: _Optional[bytes] = ..., proof_height: _Optional[_Union[_client_pb2.Height, _Mapping]] = ..., value: _Optional[bytes] = ..., time_delay: _Optional[int] = ..., block_delay: _Optional[int] = ..., merkle_path: _Optional[_Union[_commitment_pb2.MerklePath, _Mapping]] = ...) -> None: ...
