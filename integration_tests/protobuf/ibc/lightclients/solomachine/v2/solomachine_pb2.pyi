...
class ClientState(_message.Message):
    ...
    def __init__(self, sequence: _Optional[int] = ..., is_frozen: _Optional[bool] = ..., consensus_state: _Optional[_Union[ConsensusState, _Mapping]] = ..., allow_update_after_proposal: _Optional[bool] = ...) -> None: ...
