...
class TxResult(_message.Message):
    ...
    def __init__(self, height: _Optional[int] = ..., tx_index: _Optional[int] = ..., msg_index: _Optional[int] = ..., eth_tx_index: _Optional[int] = ..., failed: _Optional[bool] = ..., gas_used: _Optional[int] = ..., cumulative_gas_used: _Optional[int] = ...) -> None: ...
