...
class V0TraceConfig(_message.Message):
    __slots__ = ()
    ...
    debug: bool
    limit: int
    overrides: _chain_config_v0_pb2.V0ChainConfig
    enable_memory: bool
    enable_return_data: bool
    tracer_json_config: str
    def __init__(self, tracer: _Optional[str] = ..., timeout: _Optional[str] = ..., reexec: _Optional[int] = ..., disable_stack: _Optional[bool] = ..., disable_storage: _Optional[bool] = ..., debug: _Optional[bool] = ..., limit: _Optional[int] = ..., overrides: _Optional[_Union[_chain_config_v0_pb2.V0ChainConfig, _Mapping]] = ..., enable_memory: _Optional[bool] = ..., enable_return_data: _Optional[bool] = ..., tracer_json_config: _Optional[str] = ...) -> None: ...
