...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TraceCall = channel.unary_unary(
                ...
                request_serializer=ethermint_dot_evm_dot_v1_dot_query__pb2.QueryTraceCallRequest.SerializeToString,
                response_deserializer=ethermint_dot_evm_dot_v1_dot_query__pb2.QueryTraceCallResponse.FromString,
                _registered_method=True)
...
def add_QueryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'TraceCall': grpc.unary_unary_rpc_method_handler(
                    servicer.TraceCall,
                    request_deserializer=ethermint_dot_evm_dot_v1_dot_query__pb2.QueryTraceCallRequest.FromString,
                    response_serializer=ethermint_dot_evm_dot_v1_dot_query__pb2.QueryTraceCallResponse.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('ethermint.evm.v1.Query', rpc_method_handlers)
...
class Query(object):
    ...
    def TraceCall(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ethermint.evm.v1.Query/TraceCall',
            ethermint_dot_evm_dot_v1_dot_query__pb2.QueryTraceCallRequest.SerializeToString,
            ethermint_dot_evm_dot_v1_dot_query__pb2.QueryTraceCallResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
