...
class V0Params(_message.Message):
    __slots__ = ()
    ...
    def __init__(self, evm_denom: _Optional[str] = ..., enable_create: _Optional[bool] = ..., enable_call: _Optional[bool] = ..., extra_eips: _Optional[_Iterable[int]] = ..., chain_config: _Optional[_Union[_chain_config_v0_pb2.V0ChainConfig, _Mapping]] = ..., allow_unprotected_txs: _Optional[bool] = ...) -> None: ...
