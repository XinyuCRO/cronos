...
class Params(_message.Message):
    ...
    def __init__(self, no_base_fee: _Optional[bool] = ..., base_fee_change_denominator: _Optional[int] = ..., elasticity_multiplier: _Optional[int] = ..., enable_height: _Optional[int] = ..., base_fee: _Optional[str] = ..., min_gas_price: _Optional[str] = ..., min_gas_multiplier: _Optional[str] = ...) -> None: ...
